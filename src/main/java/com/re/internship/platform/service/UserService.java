...
import com.re.internship.platform.domain.Authority;
...
public class UserService {
    ...
    public User registerCompany(UserDTO userDTO, String password) {
        userRepository
            .findOneByLogin(userDTO.getLogin().toLowerCase())
            .ifPresent(
                existingUser -> {
        ...
        newUser.setAuthorities(authorities);
        userRepository.save(newUser);
        log.debug("Created Information for Company: {}", newUser);
        return newUser;
    }
